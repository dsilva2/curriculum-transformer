              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    Upload your traditional teaching materials and Innova
                    Schools guidelines. Our AI system will analyze them and
                    suggest innovative projects aligned with Innova Schools
                    Mexico methodology.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Reimagine Your Teaching Approach
                </h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our platform uses advanced AI to help Innova Schools Mexico
                  educators transform traditional teaching methods into
                  engaging, innovative learning experiences.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Upload your curriculum guidelines and teaching materials for
                    AI analysis.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Our RAG system analyzes content and generates innovative
                    project ideas.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Save and organize your transformed curriculum materials for
                    easy access.
                  </p>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our platform uses Retrieval Augmented Generation (RAG) to
                  analyze your materials and create innovative curriculum
                  suggestions.
                </p>
              </div>
            </div>
                ...
                <ul className="grid gap-6">
                  <li className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Upload your school guidelines and traditional teaching
                        materials to our secure platform.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Our RAG system analyzes your content, understanding the
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        The AI generates innovative project ideas and
                        assignments that align with your guidelines.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Review the suggestions, make any necessary adjustments,
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Join Innova Schools Mexico educators who are using AI to create
                more engaging, innovative learning experiences.
              </p>
            </div>
