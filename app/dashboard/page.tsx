...
export default function Dashboard() {
      ...
      try {
        ...
        if (!data.available) {
          toast({
            ...
            description:
              data.error || "Running in demo mode with mock data. Add your Groq API key for full functionality.",
            variant: "destructive",
          })
        } else {
          toast({
  ...
  const handleGuidelinesSubmit = async (data: { guidelines: string; materialTitle: string }) => {
    ...
    try {
      ...
      if (transformData.usingGroq) {
        toast({
          ...
          description: "Your materials have been successfully transformed using Groq AI.",
        })
      } else {
        toast({
          title: "Demo Mode",
          description: "Showing sample projects. Configure Groq API for personalized results.",
          variant: "warning",
        })
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: `Transformation failed: ${error instanceof Error ? error.message : "Unknown error"}`,
        variant: "destructive",
      })
        ...
        projects: [
          {
            ...
            description: "A sample project shown due to processing error. Please check your API configuration.",
            learningObjectives: ["Troubleshoot technical issues", "Understand error handling", "Learn from failures"],
        ...
        <div className="flex flex-col items-start gap-4 md:gap-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Upload your materials and transform them into innovative curriculum for Innova Schools Mexico
            </p>
          </div>
          ...
          {apiStatus.checking ? (
            <Alert className="mb-4">
              ...
              <AlertDescription>Checking connection to Groq API. This will only take a moment...</AlertDescription>
            </Alert>
          ) : apiStatus.available ? (
            ...
            <TabsContent value="upload" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload your traditional teaching materials that you want to transform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardFooter className="flex justify-between">
                  ...
                  <Button onClick={() => setActiveTab("guidelines")} disabled={!materialFile}>
                    Next
                  </Button>
                </CardFooter>
              </Card>
            ...
            <TabsContent value="guidelines" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter or upload your school's guidelines for innovative curriculum</CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardFooter className="flex justify-between">
                  ...
                  <Button onClick={() => handleGuidelinesSubmit({ guidelines, materialTitle })} disabled={isProcessing}>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <p className="text-center text-xs text-gray-500">
            Powered by {apiStatus.available ? `${apiStatus.provider} (${apiStatus.currentModel})` : "Demo Mode"}
          </p>
        </div>
      </footer>
    </div>
